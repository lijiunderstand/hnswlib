               ...
               vector<std::priority_queue<std::pair<float, labeltype>>> &answers, size_t k)
{
    ...
    ofstream dataFile;
    dataFile.open("./result.txt", ios::app);
    if(!dataFile.is_open()){
    ...
    dataFile<< ef <<","<<recall<<","<<time_us_per_query<<","<<1000000/time_us_per_query<<endl;
    }
    dataFile.close();
}
...
void siftsmall()
{
    ...
    char path_gt[1024];
    char *path_q = "/home/intel/workspace/lijie/FML/hnsw/hnswlib/siftsmall/siftsmall_query.fvecs";
    char *path_data = "/home/intel/workspace/lijie/FML/hnsw/hnswlib/siftsmall/siftsmall_base.fvecs";
    sprintf(path_index, "siftsmall_ef_%d_M_%d.bin", efConstruction, M);

    sprintf(path_gt, "/home/intel/workspace/lijie/FML/hnsw/hnswlib/siftsmall/siftsmall_groundtruth.ivecs");
